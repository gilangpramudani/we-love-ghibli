        ...
        <>
            <Layout title={data?.film?.title}>
                {data?.film != undefined && species != undefined ?
                    <div className="mt-10 mb-20 lg:text-lg">
                        <div className="">
                            ...
                            <div>
                                <div className="h-96 lg:h-[95vh] relative mt-4">
                                    <Image src={data.film.movie_banner} alt={data.film.title} layout="fill" placeholder="blur" blurDataURL={data.film.movie_banner} />
                                    <div className="h-40 w-24 lg:h-60 lg:w-36 absolute -bottom-10 left-5 border-white border-2">
                                        <Image src={data.film.image} alt={data.film.title} layout="fill" quality={10} placeholder="blur" blurDataURL={data.film.image} />
                                    </div>
                                    <div className=" absolute -bottom-8 right-5 lg:right-20">
                                        <span>Release date: {data.film.release_date}</span>
                                    </div>
                                </div>
                                <div className="mt-12 grid grid-cols-2 gap-1 lg:px-20">
                                    <div className="bg-[#dae8e5] px-5 py-2 rounded-r lg:rounded"><p className="text-center">Duration: {data.film.running_time} minute</p></div>
                                    <div className="bg-[#dae8e5] px-5 py-2 rounded-l lg:rounded"><p className="text-center">Rating: {data.film.rt_score}</p></div>
                                </div>

                                <div className="px-5 mt-10 text-justify md:px-10 lg:px-20">
                                    <div className="border-l-4 px-2 border-[#30b0e0]">
                                ...
                                <div className="px-5 mt-10 text-justify md:px-10 lg:px-20">
                                    <div className="border-l-4 px-2 border-transparent relative">
                                        ...
                                        <div className="absolute bg-[#4d695d] w-2 h-2 bottom-2 right-0" />
                                    </div>
                                ...
                                <div className="px-5 mt-10 text-justify md:px-10 lg:px-20">
                                    <div className="border-l-4 px-2 border-[#bc252d]">
                                            ...
                                            {data?.people?.map((v) => {
                                                ...
                                                return (
                                                    <div key={v.id} className="mb-5 relative py-5 border-gray-500 px-4 border-b border-l">
                                                        ...
                                                        <div className="absolute bg-[#bc252d] w-6 h-1 bottom-0 left-0" />
                                                        <div className="absolute bg-gray-500 w-[1px] h-10 top-0 right-0" />
                                                        <div className="absolute bg-[#bc252d] w-3 h-1 top-0 right-0" />
                                                    </div>
                                                )
                                            })}
                                        </div>
                                ...
                                <div className="px-5 mt-14 text-justify md:px-10 lg:px-20">
                                    <div className="border-l-4 px-2 border-[#bfdeee]">
                                        <h3 className="text-2xl ">List Locations</h3>
                                    </div>
                                    <div className="mt-5">
                                            ...
                                            {data?.location?.map((v) => {
                                                return (
                                                    <div key={v.id} className="mb-5 relative py-5 border-gray-500 border-b">
                                                        ...
                                                        <div className="absolute bg-[#bfdeee] w-6 h-1 bottom-0 left-0" />
                                                        <div className="absolute bg-gray-500 w-1 h-3 bottom-0 right-0" />
                                                        <div className="absolute bg-[#bfdeee] w-1 h-1 top-0 left-0" />
                                                    </div>
                                                )
                                            })}
                                        </div>
