      ...
      <Layout title={"Welcome to Web Studio Ghibli's Lover"}>
        {carouselImage != undefined ?
          <div className="lg:text-lg">
              ...
              {carousel?.slice(0, 3)?.map((value) =>
                <div key={value.id} className="h-96 md:h-screen w-full relative">
                  <div className="absolute h-[95%] w-full">
                    <div className="absolute top-4 md:top-10 right-0 bg-[#bfdeee] pr-5 pl-3 py-2 md:pr-14 md:pl-10 md:py-2 z-10 border border-white">

                      <span>{value.title}</span>

                    </div>
                    <Image src={value.movie_banner} alt={value.title} layout="fill" quality={50} placeholder="blur" blurDataURL={value.movie_banner} />
                  </div>
                  <div className="hidden absolute bottom-0 z-10 left-5 md:flex w-full gap-5  items-center">
                    ...
                    <div className="w-6/12 text-white bg-black bg-opacity-50 p-2">
                      ...
                      <p className="text-justify font-semibold">{value.description.substring(0, 200)}...
            ...
            <div className="md:mt-40 md:px-40 mt-20 ">
            ...
            <div className="mt-20 md:mt-40 md:px-10">
